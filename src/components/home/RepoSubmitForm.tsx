...
export function RepoSubmitForm({ isLoggedIn, authLoading = false }: Props) {
	...
	return (
		...
		>
			<Input
				className="h-12 border-slate-300 bg-white px-4 text-base text-slate-950 shadow-sm placeholder:text-slate-400 focus-visible:border-teal-700 focus-visible:ring-teal-700/20"
				name="repo"
				value={repo}
