...
import { LoadingClient, LoadingScanPanel } from '@/components/loading/LoadingClient';
...
export function LoadingPageClient() {
  ...
  if (creating || !jobId) {
    return <Shell user={user} active="loading"><LoadingScanPanel repo={repo} status="preparing" /></Shell>;
  }
